...
// Hämta användarens egna information
...
// Hämta kommentarer till din profil
$comment_sql = "SELECT 
                    c.*,
...
// Hantera formulärinlämning för uppdatering
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['form'])) {
    ...
    if ($_POST['form'] == 'delete') {
        // Här bör du lägga till lösenordskontroll
...
<div class="container">
    ...
    ?>
    <!-- Kommentarsformulär - skriv på din egen vägg -->
    ...
    <div class="edit-section">
        ...
        <!-- Lägg till detta efter navigeringslänkarna eller var du vill ha logout-knappen -->
...
function showReplyForm(commentId, commenterName) {
    // Dölj alla andra formulär först
